...
ONLINE_RUN_CHUNKS="${ONLINE_RUN_CHUNKS:-1}"
DATASET_RUN_CHUNKS="${DATASET_RUN_CHUNKS:-1}"
OUT_DIR="${OUT_DIR:-${SCRIPT_DIR}/step7_periodic_teacher_obs_o${ONLINE_RUN_CHUNKS}_d${DATASET_RUN_CHUNKS}_$(date '+%Y%m%d_%H%M%S')}"
...
python "${EVAL_SCRIPT}" \
  ...
  --schedule.online_run_chunks="${ONLINE_RUN_CHUNKS}" \
  --schedule.dataset_run_chunks="${DATASET_RUN_CHUNKS}" \
